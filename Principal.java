...
public class Principal {
	...
	public static void main(String[] args) {
		/*
		 * //Teste da associação 1 para 1 //Criando um objeto da classe Funcionario e
		 * outro da classe Computador
		 * 
		 * Funcionario f1 = new Funcionario(); Computador c1 = new Computador();
		 * 
		...
		/*
		 * //Teste da associação 1 para n Cliente c1 = new Cliente(); Cliente c2 = new
		 * Cliente();
		 * 
		 * Pedido p1 = new Pedido(); Pedido p2 = new Pedido(); Pedido p3 = new Pedido();
		 * Pedido p4 = new Pedido(); Pedido p5 = new Pedido();
		 * 
		 * c1.setNome("Maria Silva"); c2.setNome("Manoel Almeida");
		 * 
		 * p1.setValor(10.5); p2.setValor(38.9); p3.setValor(34.9); p4.setValor(32.9);
		 * p5.setValor(66.2);
		 * 
		 * //Contando para o pedido p1 quem é o seu dono p1.setCliente(c1); //Contando
		 * para o pedido p2, p3, p4 e p5 quem é o seu dono p2.setCliente(c1);
		 * p3.setCliente(c2); p4.setCliente(c1); p5.setCliente(c2);
		 * 
		 * //Contando para os clientes c1 e c2 quais são seus pedidos Pedido[] pedidosC1
		 * = new Pedido[3];
		 * 
		 ...
		 * 
		 * Pedido[] pedidosC2 = new Pedido[2]; pedidosC2[0] = p3; pedidosC2[1] = p5;
		 * c2.setPedidos(pedidosC2);
		 * 
		 * //Navegar nos pedidos usando for-each for(Pedido p : pedidosC1){
		 * System.out.println("Cliente: "+p.getCliente().getNome()+
		 * ", valor do pedido: "+p.getValor()); } for(Pedido p : pedidosC2){
		 * System.out.println("Cliente: "+p.getCliente().getNome()+
