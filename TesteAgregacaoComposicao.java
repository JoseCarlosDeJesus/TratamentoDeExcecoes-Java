...
public class TesteAgregacaoComposicao {
	...
	public static void main(String[] args) {
		/*
		 * Jogador j1 = new Jogador(); Jogador j2 = new Jogador(); Equipe e1 = new
		 * Equipe();
		 * 
		 * e1.setNome("Equipe A"); j1.setNome("Zico"); j2.setNome("Pelé");
		 * 
		 * Jogador[] jogadores = new Jogador[2]; jogadores[0] = j1; jogadores[1] = j2;
		 * 
